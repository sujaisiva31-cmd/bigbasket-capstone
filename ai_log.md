...
I ran the Pandas IQR calculation in the notebook, printed Q1, Q3, IQR, and the upper fence, counted the rows above the upper fence, applied `.clip(upper=upper)`, and checked the maximum amount after capping.